...
class AppConfig extends SharedConfig {
  ...
  ///
  /// The hive database boxes will also be stored here. look at [LocalDataSource.getBasePath] to retrieve the path.
  String get baseFolder => "nota";

  /// the name (not full path) of the folder which contains the note files inside of the [LocalDataSource.getBasePath]
  String get noteFolder => "notes";

  /// the name (not full path) of the folder which contains the temp files inside of the [LocalDataSource.getBasePath]
  String get tempFolder => "temp";
}
